...
Feature: Self-Assessment
	...
	Given that student "Renato" is registered
    And I am at Self-Assessment Page
	And there are "Requisitos" and "Gerência de Configuração" goals to be self-assess
	When "Renato" assesses the goals "Requisitos" and "Gerência de Configuração" with concept "MA"
	Then goals "Requisitos" and "Gerência de Configuração" of "Renato" are assessed with concept "MA"
    ...
    And I am at Self-Assessment Page
    And there are "Requisitos" and "Gerência de Configuração" goals to be self-assess
	When "Renato" assesses the goals "Requisitos" and "Gerência de Configuração" with concept "10"
	Then goals "Requisitos" and "Gerência de Configuração" of "Renato" are assessed with concept ""
